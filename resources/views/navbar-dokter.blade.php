    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dokter-view') }}">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('kunjungan-view-dokter') }}">Request</a>
                </li>
            </ul>
            @auth
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('profile-dokter')}}">
                                <img id="profile-preview"
                                    src="{{ Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&size=15&background=random' }}"
