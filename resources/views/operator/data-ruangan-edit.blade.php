...
@section('content')
    <div class="container-fluid px-4" style="padding-top: 60px;">
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 text-dark mb-1">Edit Ruangan</h1>
                            <p class="text-muted mb-0">Edit data ruangan yang sudah ada.</p>
                        </div>
                        <div class="text-end">
        ...
        <form action="{{ route('operator-edit-data-ruangan', $ruangan->id) }}" method="POST">
            @csrf
            @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="kodeRuangan" 
                                        value="{{ old('kodeRuangan', $ruangan->kodeRuangan) }}" 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="dayaTampung" 
                                        value="{{ old('dayaTampung', $ruangan->dayaTampung) }}" 
                                        class="form-control" required>
                                </div>
